    ...
    return(
     <div className="container m-5">
        <div className="row p-5">
            <h2 className="fs-4  p-5">Charges explained
                </h2>
            <div className="col-6 p-5"> 
               
                <h3 className="fs-6 mb-3">Securities/Commodities transaction tax</h3>
                ...
                <h3 className="fs-6 mb-3">Transaction/Turnover Charges</h3>
            ...
            <div className="col-6 p-5">
                ...
                <p>Debit transactions of mutual funds & bonds get an additional discount of ₹0.25 on the CDSL fee.</p>
                 <h3 className="fs-6 mb-3">Pledging charges</h3>
                 <p>₹30 + GST per pledge request per ISIN.</p>
                 <h3 className="fs-6 mb-3">NRI brokerage charges</h3>
                <ul>
                ...
                <h3 className="fs-6 mb-3">Account with debit balance</h3>
            ...
            <h3 className="fs-6 mb-3">Disclaimer</h3>
